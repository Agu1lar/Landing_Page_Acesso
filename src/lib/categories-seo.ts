...
const CATEGORIES_SEO: Record<EquipmentCategory, CategorySeoContent> = {
  'plataformas-elevatorias': {
    ...
    paragraphs: [
      ...
      'Nossa frota inclui plataformas tipo tesoura, lança articulada e lança telescópica (aérea), além de mastros verticais, adequadas a diferentes alturas de trabalho e capacidades de carga. Use os filtros do catálogo para ver modelos articulados ou aéreos. Cada equipamento é indicado conforme o tipo de terreno, o espaço disponível na obra e a necessidade de deslocamento — fatores que nossa equipe comercial avalia ao montar sua proposta. Os valores são informados sob consulta, de acordo com o período de locação e a logística de entrega e retirada.',
