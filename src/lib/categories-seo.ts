...
const CATEGORIES_SEO: Record<EquipmentCategory, CategorySeoContent> = {
  'plataformas-elevatorias': {
    ...
    metaDescription:
      'Aluguel de plataformas elevatórias e tesouras para obras em BH, Minas Gerais e todo o Brasil. Frota revisada, entrega na obra e orçamento rápido.',
    paragraphs: [
      ...
      'Nossa frota inclui plataformas tipo tesoura, lança articulada e mastro, adequadas a diferentes alturas de trabalho e capacidades de carga. Cada equipamento é indicado conforme o tipo de terreno, o espaço disponível na obra e a necessidade de deslocamento — fatores que nossa equipe comercial avalia ao montar sua proposta. Os valores são informados sob consulta, de acordo com o período de locação e a logística de entrega e retirada.',
