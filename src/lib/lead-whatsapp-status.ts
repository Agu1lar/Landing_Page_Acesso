...
export type LeadWhatsAppStatus = 'replied' | 'opened' | 'blocked' | 'unknown' | 'not_applicable';

/** Resolves WhatsApp engagement for admin display. */
export function resolveLeadWhatsAppStatus(
  lead: Pick<LeadRecord, 'leadKind' | 'whatsappOpened' | 'whatsappRepliedAt'>,
): LeadWhatsAppStatus {
