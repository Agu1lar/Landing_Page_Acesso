  ...
  return (
    <div className="space-y-6 py-5 [&_p]:my-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-lg border border-neutral-200 bg-surface p-4">
          <h2 className="font-semibold text-neutral-900">{t('analytics_card_title')}</h2>
          <p className="mt-1 text-sm text-neutral-600">{t('analytics_card_description')}</p>
          <Button className="mt-4" href="/dashboard/analytics" size="sm" variant="outline">
            {t('analytics_link')}
          </Button>
        </div>
      </div>
