-- Updates guindaste catalog copy: short product name and hide talha (slug unchanged for redirects)
UPDATE equipment
SET
  name = 'Guindaste Munck',
  short_description = 'Locação de guindaste Munck em BH.',
  ...
  tags = '["guindaste","munck","içamento","remoção técnica","carga pesada"]'::jsonb,
